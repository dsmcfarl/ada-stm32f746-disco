...
-- Motor
--
-- Defines the Motor abstract data type and subprograms to operate on it. Timer
-- 3 channel 1 gets mapped to PB4 (alternate function 2)
-------------------------------------------------------------------------------
package Motor is
   ...
   --
   -- Purpose:
   --    Configure the GPIO pin to use for the motor PWM.
   ----------------------------------------------------------------------------
   procedure Configure
   ...
   -- Set
   --
   -- Set the motor rotation speed with Setpoint (-1.0) being full reverse
   -- and Setpoint (1.0) being full forward.
   ----------------------------------------------------------------------------
